...
//		
		if (fastPageLoad.equalsIgnoreCase("Y")) {
			System.out.println("Set Fast Page Load...........");
//			options2.setPageLoadStrategy(PageLoadStrategy.EAGER);
		...
		if (startBrowserStatus.equalsIgnoreCase("Y")) {
			try {
				...
				try {
					driver.navigate().to("https://digitalbanking.utkarsh.bank.in/iportalweb/app/login/loginPref");
//					driver.get("https://digitalbanking.utkarsh.bank.in/iportalweb/app/login/loginPref");
...
////					driver.get("https://digitalbanking.utkarsh.bank.in/iportalweb/iRetail@1");
				} catch (Exception e) {
				...
				new WebDriverWait(driver, Duration.ofSeconds(20))
						.until(ExpectedConditions.visibilityOfElementLocated(By.id("lgnUserName"))).sendKeys("Bhaba");
				;
			} catch (Exception e) {
				e.printStackTrace();
			}
